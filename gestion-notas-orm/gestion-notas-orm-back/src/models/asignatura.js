...
export const Asignatura = sequelize.define(
    'Asignatura', //representa la tabla asignaturas
    {
        ...
        docenteId: { type: DataTypes.INTEGER, allowNull: true } // <--- agregado para la relación con Docente
    },
    {
...
Asignatura.hasMany(Nota, { foreignKey: "asignaturaId", onDelete: "RESTRICT" });
